...
import org.upsam.civicrm.contact.list.ContactListFragment;
 ...
 */
@Module(injects = { ContactDetailFragmentActivity.class,
		ContactDetailFragment.class, ContactAddressFragment.class,
		ContactTagsAndGroupsFragment.class,
		ListContactsActivitiesFragment.class, OtherInformationFragment.class,
		ContactListTabs.class, ContactListFragment.class }, library = true)
