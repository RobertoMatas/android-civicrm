			    	...
			    	{			    		
...

			    		{
...

			    			{
			    				...
			    				//hay contactos que no estan bien. son muy pocos pero para asegurar que uno en mal estado no afecta toda la sincronizacion

			    				Log.e(ContactSyncService.class.toString(), "Error contacto sincronizando");	
		    			...
		    			{		    				
		    				...
		    				//nunca ocurre pero no vamos a joder la sincronizacion porqeu un registro de la bbdd no se borra

		    				Log.e(ContactSyncService.class.toString(), "Error en la sincronizacion cuando se borra");	
